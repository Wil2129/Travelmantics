...
public class DealActivity extends AppCompatActivity {
    private CollectionReference travelDealsRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        travelDealsRef = FirebaseUtil.travelDealsRef;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICTURE_RESULT && resultCode == RESULT_OK) {
            ...
            assert imageUri.getLastPathSegment() != null;
    ...
    private void saveDeal() {
        assert txtTitle.getText() != null;
        assert txtDescription.getText() != null;
        assert txtPrice.getText() != null;
        deal.setTitle(txtTitle.getText().toString());
        deal.setDescription(txtDescription.getText().toString());
        deal.setPrice(txtPrice.getText().toString());
        if (deal.getId() == null) {
            travelDealsRef.add(deal);
        } else {
            travelDealsRef.document(deal.getId()).set(deal);
        }
    }
    ...
    private void deleteDeal() {
        ...
        travelDealsRef.document(deal.getId()).delete();
